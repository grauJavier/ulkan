...
| **`ulkan uninstall`** | `ulkan uninstall` | Uninstall Ulkan from the system (supports `--dry-run`). |
...
| `/release` | \"Make a release, Release vX.Y.Z, Deploy stable\" | Guide for creating stable GitHub releases (Tag -> Changelog -> Release) |
